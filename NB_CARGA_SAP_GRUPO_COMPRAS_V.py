...
# MAGIC %md
# MAGIC ### NB_CARGA_SAP_GRUPO_COMPRAS ###
# MAGIC Tabela com informações de grupos de compras do SAP com a visao de suprimentos.
# MAGIC 
# MAGIC 
...
def gera_tabela_saida():
  df = spark.sql(f"""
SELECT DISTINCT
       EKGRP AS COD_CHAVE_GRUPO,
       EKNAM AS DENOMINACAO
